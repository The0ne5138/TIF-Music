...
import { loginUser} from '../services/api';//import { loginUser, getProfile } from '../services/api';
    ...
    useEffect(() => {
      ...
      if (token) {
        //getProfile(token).then(user => 
          setAuthState({ isAuthenticated: true, token });//setAuthState({ isAuthenticated: true, user, token });
